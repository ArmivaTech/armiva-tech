...
const services = [
  ...
  },
  {
    ...
    desc: 'Conectamos modelos de IA con tus sistemas y flujos de trabajo actuales. Reducimos tareas repetitivas y liberamos a tu equipo para lo que realmente importa.',
  ...
  return (
    <>
        ...
        <div className={`wrap ${styles.heroInner}`}>
          <div className={styles.heroText}>
            ...
            <h1 className={styles.heroTitle}>
              ...
              <em className={`reveal grad-text ${styles.heroEm}`} data-delay="2">transforma</em>
              <span className="reveal" data-delay="3">tu empresa.</span>
            </h1>
            <p className={`${styles.heroSub} reveal`} data-delay="3">
              Convertimos inteligencia artificial en resultados medibles.
              Consultoría, desarrollo de producto y automatización para empresas
              que quieren ir más allá del hype.
            </p>
            <div className={`${styles.heroCta} reveal`} data-delay="4">
            ...
            <p className={`${styles.heroMeta} reveal`} data-delay="5">
              Basados en Elche · España &nbsp;·&nbsp; Proyectos en toda España
            </p>
          </div>
      ...
      <div className={styles.logosSection}>
        <div className="wrap">
          <p className={styles.logosLabel}>Empresas que confían en nosotros</p>
        </div>
        <LogoCarousel />
      </div>
      ...
      <section className={styles.section} id="servicios">
        <div className="wrap">
          <div className={styles.sectionHead}>
            <div>
              <span className="label reveal">Servicios</span>
              <h2 className={`${styles.sectionTitle} reveal`} data-delay="1">
                Lo que hacemos<br />con tu empresa.
              </h2>
            </div>
            <p className={`${styles.sectionLead} reveal`} data-delay="2">
              Cada proyecto empieza por entender dónde la IA puede cambiar
              un resultado real. Después decidimos qué construir.
            </p>
          </div>
      ...
      {/* ── PROCESS ── */}
      <section className={styles.sectionAlt} id="proceso">
        <div className="wrap">
          <div className={styles.sectionHead}>
            <div>
              <span className="label reveal">Proceso</span>
              <h2 className={`${styles.sectionTitle} reveal`} data-delay="1">
                Cuatro pasos.<br />Un resultado.
              </h2>
            </div>
          </div>
      ...
      <section className={styles.section} id="impacto">
        <div className="wrap">
          <span className="label reveal">En números</span>
      ...
      <section className={styles.contactSection} id="contacto">
        <div className="wrap">
          <div className={styles.contactInner}>
            ...
            <form className={`${styles.form} reveal`} data-delay="3" name="armiva-contact" method="POST">
